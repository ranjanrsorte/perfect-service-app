...
const ModulesComponent = () => {
    ...
    const showEmployeesList = sessionStorage.getItem('role') === 'Administrator' ? false : true;
    ...
    const showAssignedWork = sessionStorage.getItem('role') === 'Servicing Manager' || sessionStorage.getItem('role') === 'Servicing Leads' || sessionStorage.getItem('role') === 'Servicing Worker' ? false : true;
    ...
    const showDeliveredServices =  sessionStorage.getItem('role') === 'Accountant' || sessionStorage.getItem('role') === 'Customer' || sessionStorage.getItem('role') === 'Servicing Worker' ? true : false ;
    ...
    return (
        ...
        <div className='modulesDiv'>
            <ul className="nav flex-column">
                ...
                <li className="nav-item" hidden={showDeliveredServices}>
                    <a className="nav-link" href="/delivered">Delivered</a>
                </li>
